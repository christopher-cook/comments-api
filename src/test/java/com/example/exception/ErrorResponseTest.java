...
public class ErrorResponseTest {
    ...
    @Test
    public void constructWithCauseMessage_ErrorResponse_Success() {

        errorResponse = null;
        try {
            throw new IllegalArgumentException("test");
        } catch (Exception e) {
            errorResponse = new ErrorResponse(HttpStatus.BAD_REQUEST, e.getMessage(), e.getLocalizedMessage());
        }
    }
    ...
    @Test
    public void setCause_Success() {
        errorResponse.setCause("beCause i said so");

        assertEquals("beCause i said so", errorResponse.getCause());
    }
    @Test
    public void getCause_Success() {
        assertNull(errorResponse.getCause());
        errorResponse.setCause("msg");
        assertEquals("msg", errorResponse.getCause());
    }
